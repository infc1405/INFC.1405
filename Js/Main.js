...
(function () {
  ...
  /* ---------------- gallery ---------------- */
  // To add more pictures later: drop the file into assets/gallery/
  // and add one more line below with its filename and a short caption
  // in both languages. No other change is needed.
  var GALLERY_IMAGES = [
    // { file: "assets/gallery/vector-1.jpg", caption_fa: "تصویر وکتور ۱", caption_en: "Vector image 1" },
    // { file: "assets/gallery/vector-2.jpg", caption_fa: "تصویر وکتور ۲", caption_en: "Vector image 2" },
  ];
  ...
  // re-render gallery captions when language changes
